    ...
    >
      ...
      >
        ...
        <Box
          ...
          borderRadius="lg"
          boxShadow="xl"
          maxWidth="%" // Ajuste para evitar que ocupe demasiado espacio
          ...
          _before={{
            ...
            borderStyle: "solid",
            borderColor: isRight
              ? `transparent transparent transparent ${useColorModeValue('gray.100', 'gray.700')}`
              : `transparent ${useColorModeValue('gray.100', 'gray.700')} transparent transparent`,
          }}
        >
          ...
          {subtitle && (
            <Text fontSize="md" fontStyle="italic" color={useColorModeValue("gray.700", "gray.300")} mb={4}>
              {subtitle}
            </Text>
          )}
